			...
			if(route.params && route.params["growingPagePath"]) {
				...
				return route.routeName;
								...
								if (require('react-native').Platform.OS === 'android') {
									...
									if((type == 'Navigation/BACK' && (nav && !nav.isTransitioning)) || type == 'Navigation/COMPLETE_TRANSITION') {
										iosOnPageShow = true;
									...
									if (!iosOnPagePrepare && !iosOnPageShow) {
										return;
										 ...
										 var pageName = $$$getActivePageName$$$(nav);
		if (require('react-native').Platform.OS === 'android') {
		    if (prevNav){
		        var prevPageName = $$$getActivePageName$$$(prevNav);
...
if (typeof this.props.onNavigationStateChange === 'function') {
    ...
    try{
	 ...
	 var pageName = $$$getActivePageName$$$(_$$this.state.nav);
		if (require('react-native').Platform.OS === 'android') {
		    if (null){
		        var prevPageName = $$$getActivePageName$$$(null);
		        if (pageName == prevPageName){
  		            return;
		        }
     		}
...
/*GROWINGIO MODIFIED Thu Jun 20 2019 17:40:41 GMT+0800 (China Standard Time) */