...
(function(_$$this){
    try{
        var clickable = false;
         var growingParams = newProps.growingParams;
         if(newProps.onStartShouldSetResponder){
             clickable = true;
         }
         require('react-native').NativeModules.GrowingIOModule.prepareView(tag, clickable, growingParams);
